...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        fly_goal_1->setGeometry(QRect(670, 280, 31, 31));
        ...
        Wall_1->setGeometry(QRect(870, 320, 21, 251));
